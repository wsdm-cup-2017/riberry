...
public class RandomForestTest_extend {
	private static ArrayList<DTreeCateg2> trees2; //remember to remove static!
	public RandomForestTest_extend() {
		System.out.println("Restoring forest."); 
		try
		{
			File dir=new File("");
		    FileInputStream myFileInputStream = new FileInputStream(dir.getAbsolutePath() + "/RFmodel-extended.ser");
